 ...
 */
export const BudgetCard = memo<BudgetCardProps>(({ budget, data, transactions, categories, isExpanded, onToggleExpansion }) => {
  ...
  return (
    <div
      className={`bg-white dark:bg-gray-800 rounded-lg border transition-all duration-200 p-3 lg:p-4 ${isExpanded
