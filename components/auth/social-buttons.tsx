  ...
  return (
    <Button type="button" variant="outline" onClick={onClick} className={className}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="h-4 w-4 mr-2">
        ...
        <path fill="#4CAF50" d="M24,44c5.113,0,9.83-1.963,13.409-5.163l-6.19-5.238C29.211,35.091,26.715,36,24,36 c-5.137,0-9.583-3.343-11.296-8.005l-6.553,5.046C9.463,39.556,16.198,44,24,44z"/>
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-1.353,3.657-5.07,6.286-9.303,6.286 c-5.137,0-9.583-3.343-11.296-8.005l-6.553,5.046C9.463,39.556,16.198,44,24,44c8.822,0,19.5-6,19.5-20 C44,22.659,43.862,21.35,43.611,20.083z"/>
      </svg>
      {children}
    </Button>
  );
