    ...
    try {
      ...
      if (result.error) {
        ...
        try {
          ...
          setStep("credentials");
          setErrorMessage("Registrazione non completata. I tuoi dati non sono stati salvati. Riprova.");
        } catch (cleanupError) {
          console.error("Cleanup error:", cleanupError);
          setOnboardingError("Errore durante la pulizia. Ricarica la pagina e riprova.");
        }
        return;
      }
