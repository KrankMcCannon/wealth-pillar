export const bottomNavigationStyles = {
  container:
    'fixed bottom-0 left-0 right-0 z-[110] border-t border-primary/20 bg-card/95 px-3 py-2 pb-[calc(theme(spacing.2)+env(safe-area-inset-bottom))] backdrop-blur md:hidden',
