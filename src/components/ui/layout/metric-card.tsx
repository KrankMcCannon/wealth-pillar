...
export const MetricCard = memo(({
      ...
      <div className={cardClasses}>
        <div className={metricCardStyles.loading.container}>
          ...
          {stats && stats.length > 0 && (
            <div className={cn(metricCardStyles.stats.container, metricCardStyles.stats.gridCols[Math.min(stats.length, 3) as 1 | 2 | 3])}>
              {stats.map((_, index) => (
  ...
  return (
    <div className={cardClasses}>
            ...
            >
              <span
                className={cn(
                  ...
                  stat.variant ? metricCardStyles.stats.labelVariant[stat.variant] : subTextClasses
                )}
              >
                {stat.label}
              </span>
              <span className={cn(
                ...
                stat.variant ? metricCardStyles.stats.valueVariant[stat.variant] : subTextStrongClasses
              )}>
      ...
      {/* Actions */}
      {actions && (
        <div className={metricCardStyles.actions.container}>
          {actions}
        </div>
      )}
    </div>
