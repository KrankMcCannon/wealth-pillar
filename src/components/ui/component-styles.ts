...
export const drawerStyles = {
  content:
    'fixed bottom-0 left-0 right-0 z-150 flex max-h-[96dvh] flex-col gap-0 overflow-hidden rounded-t-3xl border-t border-border/15 bg-background shadow-xl',
  header: 'flex flex-col gap-1 border-b border-border/15 px-3 pt-2 pb-2 text-center',
