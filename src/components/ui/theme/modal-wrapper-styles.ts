export const modalWrapperStyles = {
  ...
  dialogDescription: "text-xs text-muted-foreground",
  ...
  drawerContent: "p-0",
  drawerHeader: "text-left bg-card px-4 py-3 border-b border-border shrink-0 gap-0",
  drawerTitle: "text-lg font-semibold text-black",
  drawerDescription: "text-xs text-muted-foreground",
  drawerContentBody: "px-4 py-3 text-black flex-1 overflow-y-auto",
