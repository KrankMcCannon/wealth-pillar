...
const yearSelectorStyles = {
  ...
  container: 'bg-background py-3 border-b border-border/25 shadow-sm',
  ...
  item: {
    ...
    inactive:
      'bg-primary/10 text-primary hover:bg-primary/12 hover:text-primary hover:shadow-sm hover:shadow-primary/10',
  },
  icon: {
    containerBase:
      'flex items-center justify-center w-5 h-5 rounded-full transition-all duration-200 group-hover:scale-105',
    containerActive: 'bg-primary/15',
