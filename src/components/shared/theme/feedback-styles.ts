...
export const confirmationDialogStyles = {
  ...
  buttons: {
    cancel: "w-full sm:w-auto font-semibold border border-primary text-primary bg-white hover:bg-primary hover:text-primary-foreground",
...
export const notFoundStyles = {
  ...
  content: {
    ...
    card: `w-full max-w-md ${radiusStyles.lg} bg-card ${shadowStyles.xl} border border-primary/10 p-6 space-y-6 text-center`,
    ...
    badge: `mx-auto inline-flex items-center gap-2 ${radiusStyles.full} bg-primary/10 px-3 py-1 ${typographyStyles.xs} font-semibold text-primary`,
    ...
    backButton: 'w-full',
    homeButton: 'w-full',
    backButtonVariant: "bg-white text-primary border-primary hover:bg-primary hover:text-primary-foreground",
    actionIcon: 'h-4 w-4',
  },
} as const;
