 ...
 * Centralized classNames for UserSelector component
 */
...
export const userSelectorStyles = {
  ...
  label: 'truncate max-w-[70px] transition-all duration-200',
  hoverIndicator: 'w-0 h-2 bg-primary/40 rounded-full transition-all duration-300 group-hover:w-2 shrink-0',
  dots: {
