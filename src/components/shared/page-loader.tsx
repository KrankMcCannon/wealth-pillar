    ...
    <div className="relative flex size-full min-h-[100dvh] flex-col bg-card">
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          <div className="flex size-16 items-center justify-center rounded-2xl bg-primary/10 mx-auto mb-4 animate-pulse">
        ...
        <p className="text-xs text-primary/70 mt-1">{submessage}</p>
        </div>
      </div>
    </div>
  );
