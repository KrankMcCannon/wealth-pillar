...
export const formStyles = {
  ...
  currencyInput: {
    ...
    inputBase:
      "bg-card border-primary/20 focus:ring-2 focus:ring-primary/20 text-primary text-right font-mono",
    inputWithIcon: "pl-10",
  },
  select: {
    ...
    searchInput:
      "w-full pl-8 pr-3 py-2 text-sm rounded border border-primary/20 bg-card text-primary placeholder:text-primary/40 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary",
  ...
  categorySelect: {
    ...
    searchInput:
      "w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-primary/20 bg-card text-primary placeholder:text-primary/40 focus:outline-none focus:ring-2 focus:ring-primary/20",
    ...
    recentLabel:
      "text-xs font-semibold text-primary/60 uppercase tracking-wide",
    recentList: "space-y-1",
    recentItem: "cursor-pointer outline-none focus:outline-none",
    divider: "h-px bg-primary/10 my-3",
