...
export const reportsStyles = {
  ...
  header: {
    ...
    selectTrigger: "w-full sm:w-[180px] bg-card/50 backdrop-blur-sm border-primary/10 hover:bg-primary/5 transition-colors text-primary",
  ...
  summary: {
    ...
    gradientBg: "absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none",
  },
  ...
  periods: {
    ...
    globalMetricIncome: "flex flex-col gap-1.5 p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20",
    globalMetricExpense: "flex flex-col gap-1.5 p-3 rounded-xl bg-red-500/10 border border-red-500/20",
    ...
    breakdownItem: "grid grid-cols-2 sm:grid-cols-12 items-center gap-3 sm:gap-4 p-3 rounded-lg bg-card border border-primary/10 hover:border-primary/30 hover:shadow-sm transition-all",
    breakdownType: "col-span-2 sm:col-span-3 flex items-center gap-2.5 font-medium text-sm text-primary",
    breakdownDot: "w-2.5 h-2.5 rounded-full ring-2 ring-background",
    breakdownBalance: "col-span-2 sm:col-span-2 flex flex-col items-center justify-center text-[11px] text-primary font-mono tabular-nums mt-1 sm:mt-0 whitespace-nowrap",

    // Flows: Full width on mobile, wider on desktop
    breakdownFlows: "col-span-2 sm:col-span-4 flex flex-col items-center sm:items-end gap-1 text-primary/80 font-medium tabular-nums sm:pr-2",
    ...
    breakdownNetBadge: "col-span-2 sm:col-span-3 justify-self-start sm:justify-self-end px-2.5 py-1 rounded-md text-[11px] font-bold tabular-nums min-w-[70px] text-center w-full sm:w-auto mt-2 sm:mt-0 whitespace-nowrap",
    breakdownNetPositive: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20",
  ...
  categories: {
    ...
    iconBox: "w-9 h-9 rounded-full flex items-center justify-center text-lg shadow-sm border border-primary/10",
