    ...
    <>
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-2 text-center">
          <div className="h-7 bg-muted/50 rounded-lg animate-pulse mx-auto w-32"></div>
          <div className="h-4 bg-muted/50 rounded-lg animate-pulse mx-auto w-24"></div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            <div className="h-4 bg-muted/50 rounded animate-pulse w-12"></div>
            <div className="h-9 bg-muted/50 rounded-lg animate-pulse"></div>
          </div>

          {/* Password field */}
          <div className="space-y-1">
            <div className="h-4 bg-muted/50 rounded animate-pulse w-16"></div>
            <div className="h-9 bg-muted/50 rounded-lg animate-pulse"></div>
          </div>

          {/* Remember me + forgot password */}
          <div className="h-4 bg-muted/50 rounded animate-pulse w-48"></div>
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <div className="h-4 bg-muted/50 rounded animate-pulse w-10"></div>
              <div className="h-9 bg-muted/50 rounded-lg animate-pulse"></div>
            </div>
            <div className="space-y-1">
              <div className="h-4 bg-muted/50 rounded animate-pulse w-12"></div>
