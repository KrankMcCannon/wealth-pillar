...
const accountTokens = {
  components: {
    slider: {
      ...
      addPlaceholder:
        'flex-shrink-0 w-60 h-24 border-2 border-dashed border-primary/20 rounded-lg flex items-center justify-center bg-primary/5 hover:border-primary/40 hover:bg-primary/10 transition-all duration-300 cursor-pointer group',
      addPromptIcon:
    ...
    totalBalanceLink: {
      ...
      embeddedIcon:
        'flex size-12 shrink-0 items-center justify-center rounded-2xl bg-primary/10 ring-1 ring-primary/15 sm:size-14',
