 ...
 * memoized values for person initials, icon color, background color,
...
export const useTransactionVisual = (transaction: Transaction) => {
    ...
    // Derive the initials of the first person associated with the transaction's account
...
export const useTransactionRowClasses = ({
    ...
    return useMemo(() => {
        ...
        return [
            ...
            isTransfer ? 'bg-blue-50 dark:bg-blue-900/20' : transaction.isReconciled ? 'bg-green-50 dark:bg-green-900/20' : '',
